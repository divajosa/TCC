...
<head>
  ...
  <title>Detector de queda/Alterar Email</title>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <div id="main" class="container-fluid" style="padding-right: 2px; padding-left: 2px; width: 999px;">
      <div class="retangulo endAltSen" style="height: 150px; margin: auto;" >
          <div class="form-row">
            <div class="col-md-4" style="top: 40px;">
              <label for="inputEmail">*E-mail Anterior</label>
              <input type="text" class="form-control" placeholder=" " id="inputEmail">
            </div>

            <div class="col-md-4" style="top: 40px;">
              <label for="inputNovoEmail">*Novo Email</label>
              <input type="text" class="form-control" placeholder=" " id="inputNovoEmail">
            </div>

            <div class="col-md-4" style="top: 40px;">
              <label for="inputConfirmarEmail">*Confirmar E-mail</label>
              <input type="password" class="form-control" id="inputConfirmarEmail" placeholder=" ">
            </div>
          </div>
      </div>
      <div>
      ...
      <div class="form-group col-md-12">
        <p class="button-style" style="margin-top: 40px; margin-bottom: 80px;"><a href="#" onclick="alterarEmail()">Alterar</a></p>
      </div>
    </div>
  ...
  <script src="../Resources/js/Alterar_Email.js"></script>
</body>
</html>